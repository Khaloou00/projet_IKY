      ...
      <div className="">
        ...
        {isLoading && (
          <div className="flex items-center justify-center h-screen -mt-[20vh] ">
            <Lottie animationData={Aloading} loop={true} className="w-50 " />
          </div>
        )}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-[#E5E7EB] overflow-hidden">
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className=" bg-linear-to-br from-bleu2 to-bleu3 border-b border-[#b2b4b7] ">
                    ...
                    <tr key={user.id} className=" transition-colors">
                      ...
                      <td className="p-2 md:p-4 ">
                        <div className="flex items-center space-x-3">
                          <div className=" hidden w-10 h-10 bg-linear-to-br from-blue-500 to-purple-600 rounded-full lg:flex items-center justify-center">

...
const AddProduct = () => {
  ...
  // AFFICHER LA SOUS CATEGORIE EN FONCTION DE LA CATEGORIE
  ...
  // ____ FONCTION POUR AJOUTER LES PHOTOS DES PRODUITS
  ...
  // ____ FONCTION POUR SUPPRIMER UNE PHOTO AJOUTÉE
  ...
  // ____ FONCTION POUR VIDER LES CHAMPS APRES AJOUT DU PRODUIT
  const clearData = () => {
    setNom("");

    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-white rounded-xl p-6 max-w-lg w-full shadow-lg">
        ...
        <div className="mt-6 flex justify-end gap-3">
          <button onClick={onClose} className="px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-100 cursor-pointer">
            J'annule
          </button>
          <button onClick={onConfirm} className="px-4 text-white py-2 rounded-lg bg-gradient-to-br from-amber-400 to-amber-500 cursor-pointer">
